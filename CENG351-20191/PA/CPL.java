...
public class CPL implements ICPL{
    ...
    private static String user = "recitation";//"pa1_user";  
    private static String password = "ReCiTaTiOn"; //"123456";
    private static String host = "144.122.71.65"; //"localhost";
    private static String database = "dbrecitation";//"pa1_recitation";
    ...
    @Override
    public void insertPlayer(Player player) throws AlreadyInsertedException {
        int result = 0;
